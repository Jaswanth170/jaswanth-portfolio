      ...
      <div className="pt-32 pb-24 max-w-4xl mx-auto px-6 md:px-12">
        ...
        <div className="bg-[#0D0F11] border border-white/[0.08] rounded-2xl p-6 md:p-8 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-center font-mono text-xs">
            <div className="p-4 bg-surface-subtle border border-white/[0.06] rounded-xl flex flex-col items-center gap-2">
              <Filter className="w-5 h-5 text-accent" />
              <span className="text-primary font-bold">1. Capture Payload</span>
              <span className="text-[10px] text-secondary">Webhooks / API Endpoint</span>
            </div>
            <div className="p-4 bg-surface-subtle border border-accent/40 rounded-xl flex flex-col items-center gap-2 shadow-[0_0_15px_rgba(79,140,255,0.15)]">
              <Sparkles className="w-5 h-5 text-accent animate-pulse" />
              <span className="text-primary font-bold">2. LLM Evaluation</span>
              <span className="text-[10px] text-accent">Structured JSON Schema</span>
            </div>
            <div className="p-4 bg-surface-subtle border border-white/[0.06] rounded-xl flex flex-col items-center gap-2">
              <Database className="w-5 h-5 text-accent" />
              <span className="text-primary font-bold">3. CRM Dispatch</span>
              <span className="text-[10px] text-secondary">Automated Lead Route</span>
            </div>
          </div>
        </div>
