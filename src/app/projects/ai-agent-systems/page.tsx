    ...
    <main className="min-h-screen bg-[#08090A] text-[#F5F5F5] selection:bg-accent/20 selection:text-white">
      ...
      <div className="pt-32 pb-24 max-w-4xl mx-auto px-6 md:px-12">
        ...
        <div className="flex flex-wrap gap-4 mb-12">
          ...
          >
            Inquire About Framework →
          </a>
        </div>

        {/* Architecture Box */}
        <div className="bg-[#0D0F11] border border-white/[0.08] rounded-2xl p-6 md:p-8 mb-12 font-mono text-xs">
          <span className="text-xs font-bold text-accent uppercase tracking-wider block mb-4">
            AGENT REASONING &amp; TOOL LOOP (MCP PROTOCOL)
          </span>

          <div className="p-4 bg-surface-subtle rounded-xl border border-accent/30 space-y-2">
            <div className="flex items-center gap-2 text-primary font-bold">
              <Bot className="w-4 h-4 text-accent" />
              <span>ReAct Agent Execution Loop</span>
            </div>
            <div className="text-[11px] text-secondary pl-6 border-l border-accent/40 space-y-1.5">
              <div>1. Receive Goal &amp; Inspect Environment Parameters</div>
              <div>2. Plan Tool Calls via Model Context Protocol (MCP)</div>
              <div>3. Execute Tool Action &amp; Catch Terminal Outputs</div>
              <div>4. Evaluate Step Outcome &amp; Produce Final Result</div>
            </div>
          </div>
        </div>
